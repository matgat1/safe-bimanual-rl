...
from safe_bimanual_rl.rl_utils.constraint_network import ConstraintNetwork
...
def experiment(
    ...
    # Velocity-control dynamics for ATACOM.
    # q = arm joint positions [0:14], x = EE positions [36:42].
    # Constraint network input: dim_q + dim_x = 14 + 6 = 20.
    control_system = BimanualArmDynamics(vel_limit=vel_limit)
    ...
    # Constraint network: arm joint positions (14) + EE positions (6) = 20 dims
    constraint_input_dim = control_system.dim_q + control_system.dim_x  # 14 + 6 = 20
